...
export class ThermodataComponent implements OnInit {
  columnDefs = [
    ...
    {headerName: 'Pressure [hPa]', cellStyle: { textAlign: 'center' },valueFormatter: (params:any) => params.data.pressure + " hPa",width: 140, field: "pressure"},
    {headerName: 'Temp. [C]', cellStyle: { textAlign: 'center' },editable: true,valueFormatter: (params:any) => params.data.temp + " ºC", width: 100, field: "temp"},
    {headerName: 'Temp. dew point [C]',width: 100,cellStyle: { textAlign: 'center' },valueFormatter: (params:any) => params.data.dewpoint + " ºC",field: "dewpoint"},
  ...
  public rowClassRules: RowClassRules = {
     'row-selected':function (params) {return params.data.showMarker}
  };
